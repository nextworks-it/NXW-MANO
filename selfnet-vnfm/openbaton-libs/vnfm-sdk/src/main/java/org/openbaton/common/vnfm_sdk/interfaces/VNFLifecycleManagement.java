...
public interface VNFLifecycleManagement {
  ...
  VirtualNetworkFunctionRecord instantiate(
      ...
      throws Exception;
  /**
   * This operation allows retrieving VNF instance performance statistics.
   */
  Set<VNFCStatistics> queryStats(String vnfId) throws Exception;
  
  /**
   * This operation allows retrieving VNF instance state and attributes.
   */
  VirtualNetworkFunctionRecord query(String vnfId) throws Exception;
