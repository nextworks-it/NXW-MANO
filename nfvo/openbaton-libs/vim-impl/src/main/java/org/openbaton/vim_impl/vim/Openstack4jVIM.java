...
@Service
@Scope("prototype")
public class Openstack4jVIM extends GenericVIM {

  public Openstack4jVIM(
      String username,
      String password,
      String brokerIp,
      int port,
  ...
  //      throws PluginException {
  //    super("openstack4j." + name, brokerIp, port, managementPort, context);
  //  }
  //
  //  public Openstack4jVIM(String managementPort, ApplicationContext context) throws PluginException {
  //    super("openstack4j", "", managementPort, context);
  //  }
  //
  //  public Openstack4jVIM(int port, String managementPort, ApplicationContext context)
  //      throws PluginException {
  //    super("openstack4j", managementPort, context);
  //  }
  //
  //  public Openstack4jVIM(String name, int port, String managementPort) throws PluginException {
  //    super("openstack4j", name, port, managementPort, null);
  //  }
  //
  ...
  //  }
  //
  //  public Openstack4jVIM(int port, String managementPort) throws PluginException {
  //    super("openstack4j", managementPort, null);
  //  }
